...
| [`transcript.py`](transcript.py) | Slack huddle / export JSON → transcript Markdown. |
...
[`../../tests/operations/`](../../tests/operations/) (`test_*_md*.py`, `test_github_export*.py`, `test_stdlib_html_to_md.py`, `test_transcript_ops_more.py`)
