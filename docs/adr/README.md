...
| ADR | Summary |
|-----|---------|
| [paradigm-unification.md](paradigm-unification.md) | Batch (YAML/Celery) vs event-driven (Slack Socket Mode) paradigms, target swim-lane deployables, app mapping, migration path |
