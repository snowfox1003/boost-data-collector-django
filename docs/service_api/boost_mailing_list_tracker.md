...
| `get_or_create_mailing_list_message` | sender_profile_id: int, msg_id: str, sent_at: datetime \| None, parent_id: str = '', thread_id: str = '', subject: str = '', content: str = '', list_name: str = '' | tuple[MailingListMessage, bool] | Get or create a MailingListMessage by msg_id (unique). |
