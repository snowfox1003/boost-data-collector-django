"""
Pinecone issue preprocessor for boost_library_tracker.

Wraps github_activity_tracker.preprocessors.github_preprocess.preprocess_all_issues
...
Usage (via run_cppa_pinecone_sync or run_boost_github_activity_tracker):
    ...
    preprocessor = boost_library_tracker.preprocessors.issue_preprocessor.preprocess_for_pinecone
"""
...
def preprocess_for_pinecone(
    ...
    """Preprocess Boost GitHub issues (all boostorg repos) for Pinecone upsert.
